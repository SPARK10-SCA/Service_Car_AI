...
export default function DamageTest3({ navigation }) {
            ...
            <ScrollView style={{width: "100%"}}>
                <Box>
                    ...
                    <ImageBox>
                        ...
                        {
                            breakage ? <BreakageMask source={require("../assets/images/test_output/Front_Bumper_Breakage.png")} /> : null
                        }
                        {
                            crushed ? null : null
                        }
                        {
                            scratched ? <ScratchedMask source={require("../assets/images/test_output/Front_Bumper_Scratched.png")} /> : null
                        }
                        {
