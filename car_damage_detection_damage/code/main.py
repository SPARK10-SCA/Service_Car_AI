        ...
        if (arg.label == "all") & (arg.task == "damage"):
            ...
            for i in range(4):
                trainer = Trainer(
                            ...
                            img_base_path = f"../data/custom/img",
                            size = 256,
                            model = model,
                            label = i,
                            n_class = n_cls,
    ...
    if arg.eval:
        ...
        if arg.task == 'damage':
            evaluation = Evaluation(
                        ...
                        size = 256, 
                        model = model, 
                        weight_paths = ["../data/weight/"+n for n in ["[DAMAGE][Scratch_0]Unet.pt","[DAMAGE][Separated_1]Unet.pt","[DAMAGE][Crushed_2]Unet.pt","[DAMAGE][Breakage_3]Unet.pt"]],
                        device = device,
                        batch_size = 64, 
