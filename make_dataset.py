...
def remove_random():
    ...
    while cnt>7600:
        rand = random.randrange(0,cnt)
        try:
            os.remove(train_dir+'painting/'+painting[rand])
            painting.pop(rand)
            cnt-=1
        except:
            pass
    ...
    while cnt>7600:
        rand = random.randrange(0,cnt)
        try:
            os.remove(train_dir+'sheet/'+overhall[rand])
            sheet.pop(rand)
            cnt-=1
        except:
            pass
...
def remove_custom():
    ...
    while cnt>1500:
        ...
        try:
            ...
            pass
    oh1 = [file for file in os.listdir(train_dir+'oh/') if 'Frontbumper' in file]
    oh2 = [file for file in os.listdir(train_dir+'oh/') if 'Rearbumper' in file]
    cnt=len(oh1)
    while cnt>1500:
        rand = random.randrange(0,cnt)
        try:
            os.remove(train_dir+'oh/'+oh1[rand])
            oh1.pop(rand)
            cnt-=1
        except:
            pass    
    ...
    while cnt>1500:
        rand = random.randrange(0,cnt)
        try:
            os.remove(train_dir+'oh/'+oh2[rand])
            oh2.pop(rand)
            cnt-=1
        except:
            pass       
