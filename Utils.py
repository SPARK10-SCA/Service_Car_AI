...
if __name__ == "__main__":
    ...
    if arg.make_cocoformat :
        if (arg.task == "all" or arg.task == "part"):
            ...
            tmp = RemakeCOCOformat(img_dir = '/home/work/sangyun/yolo_part/data/train/images', ann_dir = '/home/work/sangyun/yolo_part/data/train/labels', alis= f'part_train', ratio=0.1, labeling_schme=l_sch, task='part')
            tmp.coco_json() 

            tmp = RemakeCOCOformat(img_dir = '/home/work/sangyun/yolo_part/data/val/images', ann_dir = '/home/work/sangyun/yolo_part/data/val/labels', alis= f'part_val', ratio=0.1, labeling_schme=l_sch, task='part')
            tmp.coco_json() 

            tmp = RemakeCOCOformat(img_dir = '/home/work/sangyun/yolo_part/data/test/images', ann_dir = '/home/work/sangyun/yolo_part/data/test/labels', alis= f'part_test', ratio=0.1, labeling_schme=l_sch, task='part')
            tmp.coco_json() 
        ...
        if (arg.task == "all" or arg.task == "severity"):
                # part
                print("make_cocoformat[severity]")
                #label_df = pd.read_csv('code/part_labeling.csv') # Not sure why this is needed

                dir_name_img = '/home/work/AIHUB/1.Training/1.원천데이터/damage_part'
                dir_name_label = '/home/work/AIHUB/1.Training/2.라벨링데이터/damage_part'
                l_sch = ["Front bumper","Rear bumper","Front fender(R)","Front fender(L)","Rear fender(R)","Trunk lid","Bonnet","Rear fender(L)","Rear door(R)","Head lights(R)","Head lights(L)","Front Wheel(R)","Front door(R)","Side mirror(R)"]
